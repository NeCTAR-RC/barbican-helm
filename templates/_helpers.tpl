...
Vault annotations
*/}}
{{- define "barbican.vaultAnnotations" -}}
vault.hashicorp.com/role: "{{ .Values.vault.role }}"
vault.hashicorp.com/agent-inject: "true"
vault.hashicorp.com/agent-pre-populate-only: "true"
vault.hashicorp.com/agent-inject-status: "update"
vault.hashicorp.com/secret-volume-path-secrets.conf: /etc/barbican/barbican.conf.d
...
vault.hashicorp.com/agent-inject-template-secrets.conf: |
  ...
  {{ print "[simple_crypto_plugin]" }}
  {{ print "password={{ .Data.data.kek }}" }}
  {{ print "{{- end -}}" }}
{{- end }}
